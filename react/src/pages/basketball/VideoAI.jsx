...
export default function BasketballVideoAI() {
    const { user, loading } = useAuth();
    const [games, setGames] = useState([]);
    const isAdmin = isAdminUser(user);

    useMeta("Basketball Video AI | Veyro", "Upload basketball match footage for AI stat extraction. Premium feature for deep performance analysis.");
    useEffect(() => {
    ...
    return (
        <main className={`page ${styles.appPage}`}>
            <section className={styles.hero}>
                <div><div className={styles.eyebrow}>Basketball</div><h1 className={styles.h1}>Basketball Video AI</h1><p>AI-powered game video analysis.</p>
            ...
            {isAdmin && (<>
                <section className={styles.panel}><h2>Video Analysis</h2><p>Video AI for this sport is under development.</p></section>
            </>)}
        </main>
    );
}
